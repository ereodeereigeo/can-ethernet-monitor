...
dicc_variables ={
  ...
  b'401' : [ [ 'receive_error_count_m1', 2, 'uint8'], ['transmit_error_count_m1', 2, 'uint8'],\
            ['active_motor_m1', 4, 'uint16'], ['error_flags_m1', 4, 'uint16'],\
            ['limit_flags_m1', 4, 'uint16'] ],\
  b'441' : [ [ 'receive_error_count_m2', 2, 'uint8'], ['transmit_error_count_m2', 2, 'uint8'],\
            ['active_motor_m2', 4, 'uint16'], ['error_flags_m2', 4, 'uint16'],\
  ...
  b'602' : [ [ 'cell0_voltage_1' , 4, 'int16' ],[ 'cell1_voltage_1', 4, 'int16'],\
            ['cell2_voltage_1', 4, 'int16'], ['cell3_voltage_1', 4, 'int16'] ],\
  b'605' : [ [ 'cell0_voltage_2' , 4, 'int16' ],[ 'cell1_voltage_2', 4, 'int16'],\
            ['cell2_voltage_2', 4, 'int16'], ['cell3_voltage_2', 4, 'int16'] ],\
  b'608' : [ [ 'cell0_voltage_3' , 4, 'int16' ],[ 'cell1_voltage_3', 4, 'int16'],\
            ['cell2_voltage_3', 4, 'int16'], ['cell3_voltage_3', 4, 'int16'] ],\
  b'60b' : [ [ 'cell0_voltage_4' , 4, 'int16' ],[ 'cell1_voltage_4', 4, 'int16'],\
            ['cell2_voltage_4', 4, 'int16'], ['cell3_voltage_4', 4, 'int16'] ],\
  b'60e' : [ [ 'cell0_voltage_5' , 4, 'int16' ],[ 'cell1_voltage_5', 4, 'int16'],\
            ['cell2_voltage_5', 4, 'int16'], ['cell3_voltage_5', 4, 'int16'] ],\
  b'611' : [ [ 'cell0_voltage_6' , 4, 'int16' ],[ 'cell1_voltage_6', 4, 'int16'],\
            ['cell2_voltage_6', 4, 'int16'], ['cell3_voltage_6', 4, 'int16'] ],\
  b'603' : [ [ 'cell4_voltage_1' , 4, 'int16' ],[ 'cell5_voltage_1', 4, 'int16'],\
            ['cell6_voltage_1', 4, 'int16'], ['cell7_voltage_1', 4, 'int16'] ],\
  b'606' : [ [ 'cell4_voltage_2' , 4, 'int16' ],[ 'cell5_voltage_2', 4, 'int16'],\
            ['cell6_voltage_2', 4, 'int16'], ['cell7_voltage_2', 4, 'int16'] ],\
  b'609' : [ [ 'cell4_voltage_3' , 4, 'int16' ],[ 'cell5_voltage_3', 4, 'int16'],\
            ['cell6_voltage_3', 4, 'int16'], ['cell7_voltage_3', 4, 'int16'] ],\
  b'60c' : [ [ 'cell4_voltage_4' , 4, 'int16' ],[ 'cell5_voltage_4', 4, 'int16'],\
            ['cell6_voltage_4', 4, 'int16'], ['cell7_voltage_4', 4, 'int16'] ],\
  b'60f' : [ [ 'cell4_voltage_5' , 4, 'int16' ],[ 'cell5_voltage_5', 4, 'int16'],\
            ['cell6_voltage_5', 4, 'int16'], ['cell7_voltage_5', 4, 'int16'] ],\
  b'612' : [ [ 'cell4_voltage_6' , 4, 'int16' ],[ 'cell5_voltage_6', 4, 'int16'],\
            ['cell6_voltage_6', 4, 'int16'], ['cell7_voltage_6', 4, 'int16'] ],\
  ...
  b'6f7' : [ [ 'precharge_contactor_status' , 2, 'uint8' ],[ 'precharge_state', 2, 'uint8'],\
            ['12v_contactor', 4, 'uint16'], ['reservado', 4, 'nada'],\
            ['precharge_timer', 2, 'uint8'], ['precharge_timer_counter', 2, 'uint8'] ],\
  b'6f8' : [ [ 'minimum_cell_voltage' , 4, 'uint16' ],[ 'maximum_cell_voltage', 4, 'uint16'],\
            ['cmu_number_minv', 2, 'uint8'], ['cell_number_minv', 2, 'uint8'],\
            ['cmu_number_maxv', 2, 'uint8'], ['cell_number_maxv', 2, 'uint8'] ],\
  b'6f9' : [ [ 'minimum_cell_temp' , 4, 'uint16' ],[ 'maximum_cell_temp', 4, 'uint16'],\
            ['cmu_number_mint', 2, 'uint8'], ['reservado', 2, 'nada'],\
  ...
  b'6fc' : [ [ 'fan_speed0' , 4, 'uint16' ],[ 'fan_speed1', 4, 'uint16'],\
            ['consumption_fans_contactors', 4, 'uint16'], ['consumption_cmus', 4, 'uint16'] ],\
